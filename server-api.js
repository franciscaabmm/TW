...
// ============================================
// Gestor de Sessão
// Não usa nenhum armazenamento, cada instância de página gere a sessão independentemente
// ============================================

export class SessionManager {
  constructor() {
    // Não lê do armazenamento, cada instância de página é independente
    this.nick = null;
    this.password = null;
  }
